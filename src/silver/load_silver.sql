/*
    DDL Script to transform from bronze and load silver tables.

    Run with psql:

        sudo -u postgres psql -f load_silver.sql
    
    After this, we will validate the loaded data.
*/
...
\echo ''
\echo '====================================================='
\echo 'Loading Silver Layer Tables...'
\echo '====================================================='

\echo ''
\echo '------------------------------------'
\echo 'Transforming and Loading CRM Data...'
\echo '------------------------------------'
...
\echo ''
\echo '------------------------------------'
\echo 'Transforming and Loading ERP Data...'
\echo '------------------------------------'
